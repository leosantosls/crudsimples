            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="<?=base_url()?>login/authentication" id="form" method="POST" novalidate onsubmit="return validar()">

                    <input type="hidden" name="hash_log" id="hash_log" value="">
                    ...
                    <div class="col-12">
                      <p class="small mb-0 red" id="msg_login"> </p>
                    </div>
                    <!-- <div class="col-12">
              ...
              <div class="credits">
                ...
                <br>
                Alterado by <a href="#">Leonardo Santos</a>
              </div>
